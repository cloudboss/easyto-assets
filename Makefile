...
$(DIR_OUT)/$(DIR_TMPINSTALL_BTRFS_PROGS)/bin/mkfs.btrfs.static: \
	...
	@docker run --rm -t \
		-v $(DIR_ROOT)/$(DIR_OUT)/$(BTRFS_PROGS_SRC):/code:Z \
		-v $(DIR_ROOT)/$(DIR_OUT)/$(DIR_TMPINSTALL_BTRFS_PROGS):/$(DIR_TMPINSTALL_BTRFS_PROGS):Z \
...
$(CHRONY_BUILD_OUT) &: \
	...
	@docker run --rm -t \
		-v $(DIR_ROOT)/$(DIR_OUT)/$(CHRONY_SRC):/code:Z \
		-v $(DIR_ROOT)/$(DIR_OUT)/$(DIR_TMPINSTALL_CHRONY):/$(DIR_TMPINSTALL_CHRONY):Z \
		-v $(DIR_ROOT)/$(DIR_OUT)/$(DIR_TMPINSTALL_CHRONY)/$(DIR_ET):/$(DIR_ET):Z \
...
$(E2FSPROGS_BUILD_OUT) &: \
	...
	@docker run --rm -t \
		-v $(DIR_ROOT)/$(DIR_OUT)/$(E2FSPROGS_SRC):/code:Z \
...
$(DIR_OUT)/$(DIR_TMPINSTALL_KMOD)/bin/kmod: \
	...
	@docker run --rm -t \
		-v $(DIR_ROOT)/$(DIR_OUT)/$(KMOD_SRC):/code:Z \
		-v $(DIR_ROOT)/$(DIR_OUT)/$(DIR_TMPINSTALL_KMOD):/$(DIR_TMPINSTALL_KMOD):Z \
...
$(DIR_OUT)/$(DIR_TMPINSTALL_OPENSSL)/lib/libcrypto.a: \
	...
	@docker run --rm -t \
		-v $(DIR_ROOT)/$(DIR_OUT)/$(OPENSSL_SRC):/code:Z \
		-v $(DIR_ROOT)/$(DIR_OUT)/$(DIR_TMPINSTALL_OPENSSL):/$(DIR_TMPINSTALL_OPENSSL):Z \
		-e DIR_TMPINSTALL_OPENSSL=/$(DIR_TMPINSTALL_OPENSSL) \
		-w /code \
...
$(DIR_OUT)/$(DIR_TMPINSTALL_SUDO)/bin/sudo: \
	...
	@docker run --rm -t \
		-v $(DIR_ROOT)/$(DIR_OUT)/$(SUDO_SRC):/code:Z \
		-v $(DIR_ROOT)/$(DIR_OUT)/$(DIR_TMPINSTALL_SUDO):/$(DIR_TMPINSTALL_SUDO):Z \
		-v $(DIR_ROOT)/$(DIR_OUT)/$(DIR_TMPINSTALL_SUDO)/$(DIR_ET):/$(DIR_ET):Z \
		-e DIR_ET=/$(DIR_ET) \
...
$(UTIL_LINUX_BUILD_OUT) &: \
	...
	@docker run --rm -t \
		-v $(DIR_ROOT)/$(DIR_OUT)/$(UTIL_LINUX_SRC):/code:Z \
		-v $(DIR_ROOT)/$(DIR_OUT)/$(DIR_TMPINSTALL_UTIL_LINUX):/$(DIR_TMPINSTALL_UTIL_LINUX):Z \
		-e DIR_TMPINSTALL_UTIL_LINUX=/$(DIR_TMPINSTALL_UTIL_LINUX) \
		-e CFLAGS=-s \
		-e LOCALSTATEDIR=/$(DIR_ET)/var \
...
$(DIR_OUT)/$(DIR_TMPINSTALL_ZLIB)/lib/libz.a: \
	...
	@docker run --rm -t \
		-v $(DIR_ROOT)/$(DIR_OUT)/$(ZLIB_SRC):/code:Z \
		-v $(DIR_ROOT)/$(DIR_OUT)/$(DIR_TMPINSTALL_ZLIB):/$(DIR_TMPINSTALL_ZLIB):Z \
		-e DIR_TMPINSTALL_ZLIB=/$(DIR_TMPINSTALL_ZLIB) \
		-w /code \
...
$(DIR_STG_BOOTLOADER)/boot/EFI/BOOT/BOOTX64.EFI: \
	...
	@docker run --rm -t \
		-v $(DIR_ROOT)/$(DIR_OUT)/$(SYSTEMD_BOOT_ARCHIVE):/$(SYSTEMD_BOOT_ARCHIVE):Z \
		-v $(DIR_ROOT)/$(DIR_STG_BOOTLOADER):/staging:Z \
...
$(DIR_STG_KERNEL)/boot/vmlinuz-$(KERNEL_VERSION): \
	...
	@docker run --rm -t \
		-v $(DIR_ROOT)/$(DIR_OUT)/$(KERNEL_SRC):/code:Z \
		-v $(DIR_ROOT)/$(DIR_STG_KERNEL):/install:Z \
		-v $(DIR_ROOT)/kernel/config:/config:Z \
		-v $(DIR_ROOT)/kernel/installkernel:/sbin/installkernel:Z \
		-e DIR_ET=/$(DIR_ET) \
